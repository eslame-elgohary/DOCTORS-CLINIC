...
Public Class ROSHTA_T_CRS2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ROSHTA_T_CRS2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedROSHTA_T_CRS2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ROSHTA_T_CRS2 = New ROSHTA_T_CRS2()
        rpt.Site = Me.Site
        Return rpt
    End Function
