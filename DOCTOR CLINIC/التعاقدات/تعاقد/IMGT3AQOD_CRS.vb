...
Public Class IMGT3AQOD_CRS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.IMGT3AQOD_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIMGT3AQOD_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IMGT3AQOD_CRS = New IMGT3AQOD_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
