...
Public Class T3AKODAT_REP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.T3AKODAT_REP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedT3AKODAT_REP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As T3AKODAT_REP = New T3AKODAT_REP()
        rpt.Site = Me.Site
        Return rpt
    End Function
