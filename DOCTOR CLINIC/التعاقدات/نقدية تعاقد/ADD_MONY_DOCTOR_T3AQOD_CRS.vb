...
Public Class ADD_MONY_DOCTOR_T3AQOD_CRS
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ADD_MONY_DOCTOR_T3AQOD_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ADD_MONY_DOCTOR_T3AQOD_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RASED_SABEQ() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RASED_NEW() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedADD_MONY_DOCTOR_T3AQOD_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ADD_MONY_DOCTOR_T3AQOD_CRS = New ADD_MONY_DOCTOR_T3AQOD_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
