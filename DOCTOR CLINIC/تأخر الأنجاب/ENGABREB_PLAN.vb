...
Public Class ENGABREB_PLAN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ENGABREB_PLAN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedENGABREB_PLAN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ENGABREB_PLAN = New ENGABREB_PLAN()
        rpt.Site = Me.Site
        Return rpt
    End Function
