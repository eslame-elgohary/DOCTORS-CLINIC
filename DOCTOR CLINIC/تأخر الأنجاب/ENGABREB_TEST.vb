...
Public Class ENGABREB_TEST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ENGABREB_TEST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedENGABREB_TEST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ENGABREB_TEST = New ENGABREB_TEST()
        rpt.Site = Me.Site
        Return rpt
    End Function
