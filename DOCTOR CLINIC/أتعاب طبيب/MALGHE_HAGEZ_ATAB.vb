...
Public Class MALGHE_HAGEZ_ATAB
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.MALGHE_HAGEZ_ATAB.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMALGHE_HAGEZ_ATAB
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MALGHE_HAGEZ_ATAB = New MALGHE_HAGEZ_ATAB()
        rpt.Site = Me.Site
        Return rpt
    End Function
