Public Class SEARCH_PATIENT2
    Private Sub SEARCH_PATIENT2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FILL_DGV(DataGridView1, "SELECT * FROM PATIENT WHERE STAT = 'FALSE' ORDER BY PA_CODE")
