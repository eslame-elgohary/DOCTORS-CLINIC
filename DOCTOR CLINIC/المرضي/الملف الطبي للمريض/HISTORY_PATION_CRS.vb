...
Public Class HISTORY_PATION_CRS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.HISTORY_PATION_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHISTORY_PATION_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HISTORY_PATION_CRS = New HISTORY_PATION_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
