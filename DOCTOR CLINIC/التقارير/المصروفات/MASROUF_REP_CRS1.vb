...
Public Class MASROUF_REP_CRS1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.MASROUF_REP_CRS1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMASROUF_REP_CRS1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MASROUF_REP_CRS1 = New MASROUF_REP_CRS1()
        rpt.Site = Me.Site
        Return rpt
    End Function
