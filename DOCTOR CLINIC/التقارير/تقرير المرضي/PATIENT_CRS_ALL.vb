...
Public Class PATIENT_CRS_ALL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.PATIENT_CRS_ALL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPATIENT_CRS_ALL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PATIENT_CRS_ALL = New PATIENT_CRS_ALL()
        rpt.Site = Me.Site
        Return rpt
    End Function
