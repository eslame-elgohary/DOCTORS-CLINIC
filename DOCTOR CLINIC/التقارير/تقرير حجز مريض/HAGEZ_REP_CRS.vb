...
Public Class HAGEZ_REP_CRS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.HAGEZ_REP_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHAGEZ_REP_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HAGEZ_REP_CRS = New HAGEZ_REP_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
