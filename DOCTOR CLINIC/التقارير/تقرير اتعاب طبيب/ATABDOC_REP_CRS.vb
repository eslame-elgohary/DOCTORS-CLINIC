...
Public Class ATABDOC_REP_CRS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ATABDOC_REP_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedATABDOC_REP_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ATABDOC_REP_CRS = New ATABDOC_REP_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
