...
Public Class MALGHE_HAGEZ
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.MALGHE_HAGEZ.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMALGHE_HAGEZ
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MALGHE_HAGEZ = New MALGHE_HAGEZ()
        rpt.Site = Me.Site
        Return rpt
    End Function
