...
Public Class MALGHE_HAGEZ2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.MALGHE_HAGEZ2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMALGHE_HAGEZ2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MALGHE_HAGEZ2 = New MALGHE_HAGEZ2()
        rpt.Site = Me.Site
        Return rpt
    End Function
