Public Class SEARCH_DOCTOR
    Private Sub SEARCH_DOCTOR_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FILL_DGV(DataGridView1, "SELECT * FROM DOCTORS WHERE STAT = 'TRUE' ORDER BY DO_CODE")
