...
Public Class ADD_MONY_REP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ADD_MONY_REP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MONY() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedADD_MONY_REP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ADD_MONY_REP = New ADD_MONY_REP()
        rpt.Site = Me.Site
        Return rpt
    End Function
