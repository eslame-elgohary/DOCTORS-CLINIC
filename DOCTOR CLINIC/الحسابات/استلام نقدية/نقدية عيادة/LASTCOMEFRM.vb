...
WHERE        (dbo.ADD_MONY_DOCTOR.ADD_PA_CODE ='" & ADD_MONY_DOCTOR.PA_CODE.Text & "') AND (dbo.ADD_MONY_DOCTOR.ADD_DOCTOR_CODE = '" & ADD_MONY_DOCTOR.CODE_DOCTOR.Text & "') ORDER BY dbo.ADD_MONY_DOCTOR.ID DESC "
