...
Public Class DOF3A_PATION_CRS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.DOF3A_PATION_CRS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDOF3A_PATION_CRS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DOF3A_PATION_CRS = New DOF3A_PATION_CRS()
        rpt.Site = Me.Site
        Return rpt
    End Function
