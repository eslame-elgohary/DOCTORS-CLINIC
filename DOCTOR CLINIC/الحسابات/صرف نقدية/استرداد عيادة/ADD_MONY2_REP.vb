...
Public Class ADD_MONY2_REP
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DOCTOR_CLINIC.ADD_MONY2_REP.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedADD_MONY2_REP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ADD_MONY2_REP = New ADD_MONY2_REP()
        rpt.Site = Me.Site
        Return rpt
    End Function
