Public Class SEARCH_T3AKOD2
    Private Sub SEARCH_T3AKOD2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FILL_DGV(DataGridView1, "SELECT * FROM T3AKODAT WHERE STAT = 'FALSE' ORDER BY TA_CODE")
        TextBox1.Select()
    End Sub
